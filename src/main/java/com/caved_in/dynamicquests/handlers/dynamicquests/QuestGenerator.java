...
public class QuestGenerator
{
	...
	{
		return (new Random().nextInt(101) <= 50 ? generateQuestMaterial(QuestMaterialType.BLOCK ) : generateQuestMaterial(QuestMaterialType.ITEM));
	}
	...
	private static QuestEntityWrapper getRandomQuestEntity(List<QuestEntityWrapper> questEntities)
	{
		...
		questEntity.setEntityAmount(NumberUtil.getRandomInRange(questEntity.getEntityAmount() / 2, questEntity.getEntityAmount()));
		return questEntity;
	}
